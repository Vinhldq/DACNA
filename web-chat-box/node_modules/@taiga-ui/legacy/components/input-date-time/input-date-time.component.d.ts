...
export declare class TuiInputDateTimeComponent extends AbstractTuiControl<[TuiDay | null, TuiTime | null] | null> implements TuiFocusableElementAccessor {
    ...
    protected valueIdenticalComparator(oldValue: [TuiDay | null, TuiTime | null] | null, newValue: [TuiDay | null, TuiTime | null] | null): boolean;
